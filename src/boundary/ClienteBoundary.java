...
public class ClienteBoundary implements StrategyBoundary {
    ...
    public Pane render(String roleUsuario) {
        ...
        Bindings.bindBidirectional(txtEndereco.textProperty(), control.endereco);
        ...
        panCampos.add(new Label("Endereco"), 0, 3);
        panCampos.add(txtEndereco, 1, 3);


        panCampos.add(btnPesquisar, 1, 4);

        if (roleUsuario.equals("admin")) {
            panCampos.add(btnNovoCliente, 2, 0);
